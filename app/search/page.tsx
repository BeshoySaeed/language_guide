...
export default async function SearchPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  const results = query ? [
    { type: "Lesson", title: lesson.title, detail: lesson.summary, href: "/learn/de/a1/at-the-bakery" },
    ...lesson.vocabulary.map((item) => ({ type: "Vocabulary", title: item.word, detail: item.translation, href: "/learn/de/a1/at-the-bakery" })),
